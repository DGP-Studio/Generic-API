...
async def cn_get_zipped_file(file_path: str, request: Request) -> RedirectResponse:
    ...
    quality = request.headers.get("x-quality", request.headers.get("x-hutao-quality", "high")).lower()
    archive_type = request.headers.get("x-archive", request.headers.get("x-hutao-archive", "minimum")).lower()
